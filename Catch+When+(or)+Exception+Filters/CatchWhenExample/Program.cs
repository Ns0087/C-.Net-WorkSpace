    ...
    class Program
    {
        static void Main()
        {
            try
            {
                ...
                fundsTransfer.Transfer(bobBankAccount, stevenBankAccount, 30000);
            ...
            catch (ArgumentOutOfRangeException ex) when (ex.ParamName == "amount") //it catches the object of ArgumentOutOfRangeException which was thrown in the 'Transfer' method
            {
                Console.WriteLine(ex.Message);
