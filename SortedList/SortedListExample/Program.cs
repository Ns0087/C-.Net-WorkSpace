...
namespace SortedListExample
{
    class Program
    {
        static void Main()
        {
            ...
            sortedList.Add("101", 101);
            sortedList.Add("102", "102");
            sortedList.Add("103", 102.40);
            sortedList.Add("104", true);
            sortedList.Add("10", false);
            sortedList.Add("Nitim", "Nitim");
            sortedList.Add("Nitin", "Nitin");
            sortedList.Add("Ankit", "Ankit");
            sortedList.Add("Aakit", "Ankit");
